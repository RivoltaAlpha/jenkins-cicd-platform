...
if (cliDescriptor != null) {
    ...
    println("CLI descriptor not found - skipping (already disabled on this Jenkins version)")
}
...
try {
    ...
    if (existingJob != null) {
        ...
        def gitSource = new GitSCMSource("https://github.com/RivoltaAlpha/jenkins-cicd-platform.git")
